...
module.exports = {
	...
	RelatedVideo : Backbone.View.extend({
		tagName: "div",
	...
	RelatedVideos : Backbone.View.extend({
		el: "#relatedVideos",
		initialize: function(){

			this.listenTo(TN.model, "change", this.render);
		...
		render: function(){
			...
			var videos = TN.model.get("videos");
			for(var v in videos){
				var relatedVideo = new module.exports.RelatedVideo(videos[v]);
